...
<body class="text-gray-800">
   ...
   <div class="container mx-auto p-4 md:p-8">
       ...
       <header class="text-center mb-16">
           <h1 class="text-4xl md:text-5xl font-extrabold text-[#2d6a4f] mb-3">The Future is Fractional</h1>
       ...
       <main class="space-y-20">
           ...
           <section id="challenge">
               <div class="text-center mb-8">
                   <h2 class="text-3xl font-bold text-[#2d6a4f]">Europe's Digital & Energy Dilemma</h2>
               ...
               <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                   <div class="bg-white rounded-lg shadow-md p-6">
                       <h3 class="font-bold text-xl mb-4 text-[#40916c] text-center">The Growing Grid Capacity Gap</h3>
                   ...
                   <div class="flex flex-col space-y-8">
                       <div class="bg-white rounded-lg shadow-md p-6 text-center">
                           <h3 class="font-bold text-lg text-[#40916c]">Renewable Energy Target</h3>
                           <p class="text-6xl font-extrabold text-[#52b788] my-2">42.5%</p>
                       ...
                       <div class="bg-white rounded-lg shadow-md p-6 text-center">
                           <h3 class="font-bold text-lg text-[#40916c]">The Call for Sovereignty</h3>
                           <p class="text-5xl my-4 text-[#40916c]">🇪🇺</p>
           ...
           <section id="solution">
               <div class="text-center mb-8">
                   <h2 class="text-3xl font-bold text-[#2d6a4f]">A New Paradigm: The Retrofit-First FDC</h2>
               ...
               <div class="bg-white rounded-lg shadow-xl p-6 md:p-8">
                   <h3 class="font-bold text-xl mb-6 text-center text-[#40916c]">The Symbiotic Value Cycle</h3>
                   <div class="p-4 rounded-lg" style="background-color: #f0f7f4;">
                       <div class="text-center p-4 rounded-lg shadow-sm" style="background-color: #d8f3dc;">
                           <p class="font-bold text-[#1b4332]">1. 100% Renewable Power</p>
                           <p class="text-sm text-gray-700">Energy is sourced via PPAs and stored in an on-site BESS, charging at off-peak hours.</p>
                       </div>
                       <div class="flow-arrow"></div>
                       <div class="text-center p-4 rounded-lg shadow-sm" style="background-color: #b7e4c7;">
                           <p class="font-bold text-[#1b4332]">2. FDC "Data Furnace"</p>
                       ...
                       <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-center">
                           <div class="p-4 bg-white rounded-lg border-2 border-dashed border-[#52b788]">
                               <p class="font-bold text-[#1b4332]">3a. Sovereign Digital Services</p>
                               <p class="text-sm text-gray-700">Strengthening Europe's independent digital economy from the urban core.</p>
                           </div>
                           <div class="p-4 text-white rounded-lg shadow-sm" style="background-color: #40916c;">
                               <p class="font-bold">3b. 90% Heat Capture</p>
                               <p class="text-sm">Waste heat is captured as a valuable, 100% carbon-free asset.</p>
                           </div>
                       </div>
                       <div class="flow-arrow"></div>
                       <div class="text-center p-4 text-white rounded-lg shadow-sm" style="background-color: #2d6a4f;">
           ...
           <section id="sustainability">
               <div class="text-center mb-8">
                   <h2 class="text-3xl font-bold text-[#2d6a4f]">Sustainability by Design, Not by Addition</h2>
               ...
               <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                   <div class="bg-white rounded-lg shadow-md p-6">
                       <h3 class="font-bold text-xl mb-4 text-[#40916c] text-center">Development Model Carbon Footprint</h3>
                   ...
                   <div class="bg-white rounded-lg shadow-md p-6">
                       <h3 class="font-bold text-xl mb-4 text-[#40916c] text-center">Decarbonizing Urban Heating</h3>
           ...
           <section id="grid">
               <div class="text-center mb-8">
                   <h2 class="text-3xl font-bold text-[#2d6a4f]">From Grid Problem to Grid Partner</h2>
               ...
               <div class="grid grid-cols-1 md:grid-cols-5 gap-8">
                   <div class="md:col-span-3 bg-white rounded-lg shadow-md p-6">
                       <h3 class="font-bold text-xl mb-4 text-[#40916c]">Shifting Demand, Reducing Strain</h3>
                   ...
                   <div class="md:col-span-2 bg-white rounded-lg shadow-md p-6 flex flex-col justify-center">
                       <h3 class="font-bold text-xl mb-4 text-[#40916c]">Key Grid Benefits</h3>
                       <ul class="space-y-4">
                           <li class="flex items-start">
                               <span class="text-2xl text-[#40916c] mr-3">✔</span>
                               <div>
           ...
           <section id="alignment">
               <div class="text-center mb-8">
                   <h2 class="text-3xl font-bold text-[#2d6a4f]">Strategic & Financial Enablers</h2>
               ...
               <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 text-center">
                   <div class="bg-white rounded-lg shadow-md p-6">
                       <h3 class="font-bold text-lg text-[#40916c]">"Acceleration Zones"</h3>
                       <p class="text-5xl font-extrabold text-[#52b788] my-3">3</p>
                   ...
                   <div class="bg-white rounded-lg shadow-md p-6">
                       <h3 class="font-bold text-lg text-[#40916c]">"Fonds Chaleur"</h3>
                       <p class="text-5xl font-extrabold text-[#52b788] my-3">€</p>
                   ...
                   <div class="bg-white rounded-lg shadow-md p-6">
                       <h3 class="font-bold text-lg text-[#40916c]">EED & RED III Mandates</h3>
                       <p class="text-5xl font-extrabold text-[#52b788] my-3">✓</p>
   ...
   <script>
       const coolGreens = ['#40916c', '#52b788', '#95d5b2', '#d8f3dc', '#2d6a4f'];
       ...
       new Chart(document.getElementById('gridGapChart').getContext('2d'), {
           ...
           data: {
               ...
               datasets: [{
                   ...
                   data: [100, 150, 185],
                   backgroundColor: [coolGreens[2], coolGreens[1], coolGreens[4]],
                   borderWidth: 0
               }]
           },
       ...
       new Chart(document.getElementById('carbonFootprintChart').getContext('2d'), {
           ...
           data: {
               ...
               datasets: [{
                   data: [15, 85],
                   backgroundColor: [coolGreens[0], coolGreens[3]],
                   borderColor: '#ffffff',
                   borderWidth: 4,
                   hoverOffset: 4
               }]
       ...
       new Chart(document.getElementById('heatingDisplacementChart').getContext('2d'), {
           ...
           data: {
               ...
               datasets: [
                   ...
                   { label: 'Carbon-Free Heat (FDC)', data: [0, 65], backgroundColor: coolGreens[0] },
                   { label: 'Other Renewables', data: [15, 15], backgroundColor: coolGreens[2] }
               ]
           },
